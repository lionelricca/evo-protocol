...
assert(source.includes("dataset.evoNavVersion='273'"),'New controls must expose the installed navigation version');
...
assert(index.includes('back-to-top.js?v=20260821-v272-context'),'Index must directly request contextual navigation while V2.7.3 remains backward-cache compatible');

console.log('EVO V2.7.3 contextual back-to-top checks passed');
