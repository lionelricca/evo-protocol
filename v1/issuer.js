...
console.info('EVO Issuer Trust V0.1',{levels:['SELF_DECLARED','WALLET_PROVEN','DOMAIN_VERIFIED','ORGANIZATION_VERIFIED'],domainMethod:'DNS_TXT',mode:'SIGNED PROFILE + PUBLIC VERIFY BADGE + DNS DOMAIN PROOF / NO LEGAL BRAND CLAIM / NO TOKEN MOVEMENT'});
