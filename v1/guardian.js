...
function guardianMarkup(g){
  ...
  <div class="guardianMeters"><div class="guardianMeter"><div><span>Risk score</span><b>${risk}/100</b></div><div class="meterTrack"><i style="width:${risk}%"></i></div></div><div class="guardianMeter"><div><span>Evidence confidence</span><b>${confidence}%</b></div><div class="meterTrack confidence"><i style="width:${confidence}%"></i></div></div></div>
...
function injectChallengeStyles(){
  if(document.getElementById('evoChallengeClockStyle'))return;
  const s=document.createElement('style');s.id='evoChallengeClockStyle';
  s.textContent=`.challengeClockBox{display:flex;align-items:center;justify-content:space-between;gap:16px;padding:16px 18px;border:1px solid #9959ff55;border-radius:16px;background:linear-gradient(135deg,#9959ff12,#24c5ff0d);position:sticky;top:86px;z-index:4}.challengeClockBox span{display:block;color:#aaa4bd;font-size:11px;letter-spacing:.09em;text-transform:uppercase}.challengeClockBox strong{font-size:30px;line-height:1;font-variant-numeric:tabular-nums;min-width:86px;text-align:center}.challengeClockBox small{color:#f4ca75;text-align:right}.challengeClockBox.live strong{color:#f4ca75}.challengeClockBox.done strong{color:#69efba}.challengeClockBox.expired strong{color:#ff7696}@media(max-width:850px){.challengeClockBox{position:static;flex-wrap:wrap}.challengeClockBox strong{order:3;width:100%;text-align:left}}`;
